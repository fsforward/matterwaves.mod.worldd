...
public class NetherBlackDiamondOreBlock extends WorlddModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("worldd:nether_black_diamond_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("nether_black_diamond_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("worldd:nether_black_diamond_ore"), configuredFeature);
		}
	}
