...
public class TitaniumOreBlock extends WorlddModElements.ModElement {
	@ObjectHolder("worldd:titanium_ore")
	public static final Block block = null;

	public TitaniumOreBlock(WorlddModElements instance) {
		super(instance, 6);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(4f, 11f).setLightLevel(s -> 0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().speedFactor(1.2000000000000002f).jumpFactor(1.2000000000000002f));
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("worldd:titanium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("worldd:titanium_ore"), configuredFeature);
		}
	}
