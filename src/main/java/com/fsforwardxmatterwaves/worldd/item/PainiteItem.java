...
public class PainiteItem extends WorlddModElements.ModElement {
	@ObjectHolder("worldd:painite")
	public static final Item block = null;

	public PainiteItem(WorlddModElements instance) {
		super(instance, 40);
	}
