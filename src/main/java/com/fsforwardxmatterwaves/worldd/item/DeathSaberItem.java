...
public class DeathSaberItem extends WorlddModElements.ModElement {
	@ObjectHolder("worldd:death_saber")
	...
	public void initElements() {
		...
		}, 3, -3.2f, new Item.Properties().group(WorldDItemGroup.tab).isImmuneToFire()) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("Flaming red hot beam of light cutting through anything you like"));
			}
