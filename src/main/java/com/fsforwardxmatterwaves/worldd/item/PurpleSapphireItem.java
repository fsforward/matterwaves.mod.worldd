...
public class PurpleSapphireItem extends WorlddModElements.ModElement {
	@ObjectHolder("worldd:purple_sapphire")
	public static final Item block = null;

	public PurpleSapphireItem(WorlddModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("purple_sapphire");
		}
